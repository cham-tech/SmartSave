...
<div class="container-fluid py-3">
    ...
    <div class="row g-4">
                            ...
                            <?php foreach ($savingsGoals as $goal): ?>
                                <a href="savings.php?id=<?php echo $goal['id']; ?>" class="list-group-item list-group-item-action">
                                    ...
                                    <div class="progress mb-2" style="height: 10px;">
                                        <div class="progress-bar bg-success" style="width: <?php echo getSavingsProgressPercentage($goal['current_amount'], $goal['target_amount']); ?>%"></div>
                                    </div>
        ...
        <div class="col-md-6">
                        ...
                        <div class="list-group">
                            <?php foreach ($activeLoans as $loan): ?>
                                <a href="loans.php?id=<?php echo $loan['id']; ?>" class="list-group-item list-group-item-action">
                                    ...
                                    <p class="mb-1 fw-semibold"><?php echo formatCurrency($loan['amount']); ?></p>
                                    <small class="text-muted">
                                        <?php echo $loan['due_date'] ? 'Due: ' . date('M j, Y', strtotime($loan['due_date'])) : 'Pending approval'; ?>
                                    </small>
                                </a>
                            <?php endforeach; ?>
                        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">My Savings Circles</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="list-group">
                            <?php foreach ($savingGroups as $group): ?>
                                <a href="groups.php?id=<?php echo $group['id']; ?>" class="list-group-item list-group-item-action">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="mb-1 fw-semibold"><?php echo htmlspecialchars($group['name']); ?></h6>
                                        <small><?php echo ucfirst($group['cycle_frequency']); ?></small>
                                    </div>
                                    <p class="mb-1 fw-medium"><?php echo formatCurrency($group['amount_per_cycle']); ?> per cycle</p>
