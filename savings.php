...
<div class="container-fluid mt-4">
    ...
    // Main page logic:
    if (isset($_GET['id'])):
        // Show single goal details and transactions with deposit/withdraw forms
    ...
    <div class="row">
        <!-- Left column: goal details + transactions -->
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-8"><?php echo ucfirst($goal['frequency']); ?></dd>

                        <dt class="col-sm-4">Next Saving Date</dt>
                        <dd class="col-sm-8"><?php echo date('M j, Y', strtotime($goal['next_saving_date'])); ?></dd>
                        ...
                        <dd class="col-sm-8"><?php echo date('M j, Y', strtotime($goal['created_at'])); ?></dd>
                    </dl>
                </div>
            </div>
        ...
        <!-- Right column: deposit and withdraw forms -->
    ...
    <?php if (empty($goals)): ?>
        <div class="alert alert-info">You have no savings goals yet. Create one to get started.</div>
    <?php else: ?>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body d-flex flex-column">
                        <h5 class="card-title"><?php echo htmlspecialchars($goal['goal_name']); ?></h5>
                        ...
                        <a href="savings.php?id=<?php echo $goal['id']; ?>" class="btn btn-primary mt-auto align-self-start">View Details</a>
